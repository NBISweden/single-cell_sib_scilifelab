...
.citation[
.cite[<i class="fas fa-link"></i> Schwanh??usser B, *et al.* "Global quantification of mammalian gene expression control" [Nature 2011](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-0881-8)]
]
...
.citation[
.cite[<i class="fas fa-link"></i> Liu, *et al.* "On the Dependency of Cellular Protein Levels on mRNA Abundance" [Cell 165 2016](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-0881-8)]
]
...
.citation[
.cite[<i class="fas fa-link"></i> Aebersold & Mann. "Mass-spectrometric exploration of proteome structure and function." [Nature 2016](https://bmcbiol.biomedcentral.com/articles/10.1186/1741-7007-12-42)]  
.cite[<i class="fas fa-link"></i> See also Wei, *et al*. "Single-cell phosphoproteomics resolves adaptive signaling dynamics and informs targeted combination therapy in glioblastoma." [Cancer Cell. 2016](https://www.cell.com/molecular-cell/fulltext/S1097-2765(12)00481-9).]  
]  
---
name: applications
class: spaced
...
- Biomarkers for cell cycle state
...
.citation[
.cite[<i class="fas fa-link"></i> Gut G  *et al.* "Multiplex protein maps link subcellular organization to cellular states." [Science 2018 ](https://bmcbiol.biomedcentral.com/articles/10.1186/1741-7007-12-42)]  
...
.citation[
.cite[<i class="fas fa-link"></i> Stoeckius  *et al.* "Simultaneous epitope and transcriptome measurement in single cells." [Nature Methods 2017 ](https://bmcbiol.biomedcentral.com/articles/10.1186/1741-7007-12-42)]
.cite[<i class="fas fa-link"></i> Peterson VM *et al.* "Multiplexed quantification of proteins and transcripts in single cells." [Nat Biotech 2017](https://bmcbiol.biomedcentral.com/articles/10.1186/1741-7007-12-42)]  
.cite[<i class="fas fa-link"></i> Mimitou EP *et al.* "Multiplex detection of proteins, transcriptomes, clonotypes and CRISPR perturbations in single cells." [Nature Methods 2019 ](https://bmcbiol.biomedcentral.com/articles/10.1186/1741-7007-12-42)]  
]
---
name: ImmuneSeq
class: spaced
...
**Advantage** Can join multiple samples before sequencing and use the tags to seperate the cells 
...
**Advantage** They claym that you can do up to five different assays using this protocoll. 
...
pearson correlation between RNA-protein pseudotime: 0.83
...
-  Very selldom contradictory results, *e.g.* protein levels go up and RNA levels go down, over time. 
...
* Better predictor if TF changes over time but works ok even in steady state cells!
...
- Can we co-measure global mRNA and intracellular protein in single cells?
  - Yes we can!
- How are mRNA-protein co-expressed? In cells at steady-state or undergoing a stable-state change?
  - Very little correlation unless you follow over time or in different celltypes.
- How can protein measurements aid to decipher cell state and gene regulatory networks?
  - More stable expression levels ( Not shown in this lecture). Better biomarkers. But not as good as the surface protein makers.
...
- The data and the markdown files can be downloaded here
