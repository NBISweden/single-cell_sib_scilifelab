...
We have to tune some parameters here to get this right
...
Plotting RNA velocity on an existing dimensionality reduction may introduce some artifacts, particularly for cells at the "border". What if their future cell state is not contained in any of the other cells in the dataset? Observe how the arrows at the end of the two terminal populations 
