...
For this workshop, I ran the kallisto/BUStools quantification pipeline using a nextflow workflow (available on request), for which the output files can be downloaded at **LINK** Unzip this as the data folder and you're good to go! The dataset contains adipocyte progenitors and was generated using 10X single-cell 3' v2 chemistry [@merrickIdentificationMesenchymalProgenitor2019]. 
