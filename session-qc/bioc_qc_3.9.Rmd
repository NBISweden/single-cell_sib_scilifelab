...
qc.nexprs <- isOutlier(df$total_features_by_counts, nmads=3, log=TRUE, type="lower")
qc.mito <- isOutlier(df$pct_counts_Mito, nmads=3, type="higher")
qc.ribo <- isOutlier(df$pct_counts_Ribo, nmads=3, type="higher")
